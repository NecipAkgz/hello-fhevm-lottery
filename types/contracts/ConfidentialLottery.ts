...
export interface ConfidentialLotteryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "buyTicket"
...
export namespace TicketPurchasedEvent {
  export type InputTuple = [buyer: AddressLike, ticket: BigNumberish];
  export type OutputTuple = [buyer: string, ticket: bigint];
  export interface OutputObject {
    buyer: string;
    ticket: bigint;
  }
...
export namespace WinnerDrawnEvent {
  export type InputTuple = [winner: AddressLike, winningNumber: BigNumberish];
  export type OutputTuple = [winner: string, winningNumber: bigint];
  export interface OutputObject {
    winner: string;
...
export interface ConfidentialLottery extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialLottery;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialLotteryInterface;
  ...
  getMyTicket: TypedContractMethod<[], [bigint], "view">;
  ...
  ): TypedContractMethod<[_ticketNumber: BigNumberish], [void], "payable">;
  getFunction(
  ...
  filters: {
    ...
    "TicketPurchased(address,uint8)": TypedContractEvent<
      TicketPurchasedEvent.InputTuple,
      TicketPurchasedEvent.OutputTuple,
      TicketPurchasedEvent.OutputObject
    >;
    ...
    "WinnerDrawn(address,uint8)": TypedContractEvent<
      WinnerDrawnEvent.InputTuple,
      WinnerDrawnEvent.OutputTuple,
      WinnerDrawnEvent.OutputObject
    >;
